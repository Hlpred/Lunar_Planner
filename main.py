...
gravity_correction = Lunar_planner.grav_adjustment(maneuver_data[0], dv_corrected, engine_accel1)
print(f'Required Delta-V: {round(gravity_correction[1], 5)} m/s')
...
def mid_course():
  ...
  print(f'Apply {Lunar_planner.mid_course_fixed(altitude, land_ele+landing_margin, velocity, range, vy)} m/s delta-V')
